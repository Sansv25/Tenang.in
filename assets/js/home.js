      ...
      checkedInState.innerHTML = `
        <div style="padding: 20px 24px; max-width: 600px; margin: 0 auto; text-align:center;">
          <div style="margin: 0 auto 8px; display: flex; align-items: center; justify-content: center;">
            <img src="assets/img/maskots/mascot-mood-${mood.level}.png" alt="Mood ${mood.level}" style="width: 220px; height: 220px; object-fit: contain; transform: scale(1.45); filter: drop-shadow(0 14px 35px ${bgGlows[mood.level]}); margin: -25px auto -15px; transition: transform 0.3s ease;">
          </div>
